...
public class Test {
    ...
    private static String outputPath = "D:\\kon_data\\JAVA_DATA\\SpotRenaming\\SematicDetect\\src\\main\\resources\\raw_sentence.txt";
    public static void main(String[] args) throws Exception {
        //输入文本文件的目录
        File inputTxt = new File("D:\\kon_data\\JAVA_DATA\\SpotRenaming\\SematicDetect\\src\\main\\resources\\raw_sentence.txt");
